...
def load_pairs(train_or_test):
    with open("/content/drive/My Drive/data (1)/" + 'pairs_' + train_or_test + '_ints.txt', 'r', encoding='utf-8') as file:
...
if __name__ == "__main__":
    ...
    with open("/content/drive/My Drive/data (1)/" + 'vocab_source.json', 'r') as file:
        vocab_source = json.load(file)  # word -> index

    with open("/content/drive/My Drive/data (1)/" + 'vocab_target.json', 'r') as file:
